...
most cases, render images, run Javascript, Flashj, Java Applets and leave room
...
Start with all  of the includes that go along  with socket communication, shown
in Listing 1-1.

#+caption:"http.c" header includes
#+name:http.c-header-includes
#+header: :mkdirp yes :tangle resources/src/http.c
#+begin_src c
  /**
...
The following are function declarations required by C99.

#+caption:"http.c" function declarations
#+name:http.c-function-declarations
#+header: :mkdirp yes :tangle resources/src/http.c
#+begin_src c
